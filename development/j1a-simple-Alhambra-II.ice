{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "9d634538-2070-45d2-a4c2-2faebb9d2678",
          "type": "basic.inputLabel",
          "data": {
            "blockColor": "fuchsia",
            "name": "uart0_rd",
        ...
        {
          "id": "5a18a32f-2764-45ea-981a-052e36256c7f",
          "type": "basic.outputLabel",
          "data": {
            "blockColor": "fuchsia",
            "name": "uart0_wr",
        ...
        {
          "id": "aa364f0e-27b9-4587-8c0c-00b1249db99d",
          "type": "basic.outputLabel",
          "data": {
            "blockColor": "fuchsia",
            "name": "io_rd",
        ...
        {
          "id": "f80f6aaf-cccf-4699-925a-6dab8708fc01",
          "type": "basic.inputLabel",
          "data": {
            "blockColor": "fuchsia",
            "name": "uart0_wr",
        ...
        {
          "id": "b97929a3-347f-47ee-b03e-117db6a0868d",
          "type": "basic.outputLabel",
          "data": {
            "name": "mem_addr",
            "range": "[15:0]",
        ...
        {
          "id": "5b45b85b-c5a7-4a05-b031-d118c7d2e03d",
          "type": "basic.outputLabel",
          "data": {
            "blockColor": "fuchsia",
            "name": "uart0_rd",
        ...
        {
          "id": "49fc047b-99b3-48b5-8d35-d4ce9485e825",
          "type": "basic.outputLabel",
          "data": {
            "name": "mem_addr",
            "range": "[15:0]",
        ...
        {
          "id": "7fea5690-d9e9-4d67-a28d-9984590e18de",
          "type": "basic.output",
          "data": {
            "name": "out",
            "range": "[4:0]",
        ...
        {
          "id": "8feef2b6-ee4b-4f0d-96d3-262eefa870ac",
          "type": "basic.code",
          "data": {
        ...
        {
          "id": "dc9e68ff-6168-40ea-a896-285a55555d1d",
          "type": "basic.code",
          "data": {
        ...
        {
          "id": "7b6794fc-35f7-4c5f-8270-731a2568872c",
          "type": "basic.code",
          "data": {
        ...
        {
          "id": "36d64a36-c9e4-48c3-9f16-479ab7593d23",
          "type": "basic.code",
          "data": {
        ...
        {
          "id": "7fb83f49-be7b-4328-b029-f25877b2e65a",
          "type": "b472606685bbe9a5cfea747f50640e375e54185a",
          "position": {
            "x": 520,
            "y": 656
          },
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "8feef2b6-ee4b-4f0d-96d3-262eefa870ac",
            "port": "insn"
          },
          "target": {
        ...
        {
          "source": {
            "block": "49fc047b-99b3-48b5-8d35-d4ce9485e825",
            "port": "outlabel"
          },
          "target": {
            "block": "dc9e68ff-6168-40ea-a896-285a55555d1d",
            "port": "io_addr_"
          },
          "vertices": [],
          "size": 16
        ...
        {
          "source": {
            "block": "7b6794fc-35f7-4c5f-8270-731a2568872c",
            "port": "port"
          },
          "target": {
            "block": "7fea5690-d9e9-4d67-a28d-9984590e18de",
            "port": "in"
          },
          "vertices": [],
          "size": 5
        ...
        {
          "source": {
            "block": "5b45b85b-c5a7-4a05-b031-d118c7d2e03d",
            "port": "outlabel"
          },
          "target": {
            "block": "2a4103aa-af77-413f-81ad-9eb8daeef849",
        ...
        {
          "source": {
            "block": "7fb83f49-be7b-4328-b029-f25877b2e65a",
        ...
        {
          "source": {
            "block": "36d64a36-c9e4-48c3-9f16-479ab7593d23",
            "port": "uart0_wr"
          },
          "target": {
            "block": "f80f6aaf-cccf-4699-925a-6dab8708fc01",
            "port": "inlabel"
          },
          "vertices": []
        },
        {
          ...
          "target": {
            "block": "9d634538-2070-45d2-a4c2-2faebb9d2678",
            "port": "inlabel"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "aa364f0e-27b9-4587-8c0c-00b1249db99d",
            "port": "outlabel"
          },
          "target": {
            "block": "36d64a36-c9e4-48c3-9f16-479ab7593d23",
        ...
        {
          "source": {
            "block": "5a18a32f-2764-45ea-981a-052e36256c7f",
            "port": "outlabel"
          },
          "target": {
            "block": "3515b484-5394-44ca-9813-6b2c18605a23",
        ...
        {
          "source": {
            "block": "b97929a3-347f-47ee-b03e-117db6a0868d",
            "port": "outlabel"
          },
          "target": {
            "block": "36d64a36-c9e4-48c3-9f16-479ab7593d23",
  ...
  "dependencies": {
    ...
    "b472606685bbe9a5cfea747f50640e375e54185a": {
      "package": {
        "name": "Return-stack",
        "version": "0.1",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "513e23ef-561f-461f-b62e-4ac74175a4f4",
              "type": "basic.code",
              "data": {
                "code": "localparam WIDTH = 16;\nlocalparam DEPTH = 17;\nlocalparam BITS = (WIDTH * DEPTH) - 1;\n\nwire move = delta[0];\n\nreg [15:0] head;\nreg [BITS:0] tail;\nwire [15:0] headN;\nwire [BITS:0] tailN;\n\nassign headN = we ? wd : tail[15:0];\nassign tailN = delta[1] ? {16'h55aa, tail[BITS:16]} : {tail[BITS-16:0], head};\n\n  always @(posedge clk) begin\n    if (we | move)\n      head <= headN;\n    if (move)\n      tail <= tailN;\n  end\n\n  assign rd = head;\n",
                "params": [],
          ...
          "wires": [
            {
              "source": {
                "block": "513e23ef-561f-461f-b62e-4ac74175a4f4",
                "port": "rd",
                "size": 16
              },
              "target": {
